 ...
 * analyses for the JPMAIL System with a particular focus on the coupling
 ...
 * 100 analysis nodes.
 * 
 * The evaluation is based on JPMAIL system, documented in the results of
 * the uncertainty propagation evaluation.
 */
public class JPMAILCodeQlEDFAPropagationScalabilityEvaluation {
	...
	// and EDFA) for the JPMAIL system.
	@Test
