 ...
 * analyses for the Eclipse Secure Storage System with a particular focus on the coupling
 * between CodeQL and EDFA.
 * 
 ...
 * 100 analysis nodes.
 * 
 * The evaluation is based on Eclipse Secure Storage system, documented in the results of
 * the uncertainty propagation evaluation.
 */
public class EclipseSecureStorageCodeQlEDFAPropagationScalabilityEvaluation {

	// This test measures the runtime scalability of the uncertainty propagation
	// when applied to a coupling graph consisting of two analysis nodes (CodeQL
	// and EDFA) for the Eclipse Secure Storage system.
	@Test
	...
	// This test measures the runtime scalability of the uncertainty propagation
	// on a ten node coupling graph created by repeating the same CodeQL and EDFA
	// analysis nodes
	// for the Eclipse Secure Storage system.
	@Test
	public void testUncertaintyPropagationRuntimeTenNodeCouplingGraph() throws Exception {
		...
		// Build a graph with 10 nodes (5 repetitions of CodeQL + EDFA)
		AnalysisGraph g = buildRepeatedAnalysisGraph(graph, AnalysisType.CODEQL, AnalysisType.EDFA, 4);
	...
	// This test measures the runtime scalability of the uncertainty propagation
	// on a 100-node coupling graph created by repeating the same CodeQL and EDFA
	// analysis nodes
	// for the Eclipse Secure Storage system.
	@Test
	public void testUncertaintyPropagationRuntimeHundredNodeCouplingGraph() throws Exception {
		...
		// Build a graph with 100 nodes (50 repetitions of CodeQL + EDFA)
		AnalysisGraph g = buildRepeatedAnalysisGraph(graph, AnalysisType.CODEQL, AnalysisType.EDFA, 49);
