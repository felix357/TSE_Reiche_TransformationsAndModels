 ...
 * coupled model-based analyses for the CoCoMe system, specifically for
 ...
 * CoCoMe system, as documented in the results XML file of the
 * uncertainty mitigation assessment.
 */
public class CoCoMeJoanaEDFAMitigationEvaluation {
