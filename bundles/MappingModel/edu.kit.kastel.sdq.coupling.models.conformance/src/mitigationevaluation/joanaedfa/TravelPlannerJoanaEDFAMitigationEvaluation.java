 ...
 * coupled model-based analyses for the TravelPlanner system, specifically for
 ...
 * TravelPlanner system, as documented in the results XML file of the
 * uncertainty mitigation assessment.
 */
public class TravelPlannerJoanaEDFAMitigationEvaluation {
	...
	public void graphWithIC1MappingValidTest() throws Exception {
		...
		Path gtFile = Paths.get(cfg.basePath + "/travelplanner.groundTruth.xml");
