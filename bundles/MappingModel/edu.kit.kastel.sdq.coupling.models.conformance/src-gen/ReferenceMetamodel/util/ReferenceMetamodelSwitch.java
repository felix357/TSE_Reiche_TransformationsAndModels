 ...
 * @generated
 */
public class ReferenceMetamodelSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ReferenceMetamodelSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ReferenceMetamodelPackage.SECURITY_CHARACTERISTIC: {
			...
			case ReferenceMetamodelPackage.ANNOTATION: {
				Annotation annotation = (Annotation)theEObject;
				T result = caseAnnotation(annotation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ReferenceMetamodelPackage.SYSTEM_ELEMENT: {
				SystemElement systemElement = (SystemElement)theEObject;
				T result = caseSystemElement(systemElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ReferenceMetamodelPackage.CONFIGURATION: {
				Configuration configuration = (Configuration)theEObject;
				T result = caseConfiguration(configuration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ReferenceMetamodelPackage.SECURITY_POLICY: {
