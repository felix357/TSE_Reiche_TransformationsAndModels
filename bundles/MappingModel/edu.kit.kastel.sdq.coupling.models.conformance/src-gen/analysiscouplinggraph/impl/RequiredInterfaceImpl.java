 ...
 * </p>
 * <ul>
 *   <li>{@link analysiscouplinggraph.impl.RequiredInterfaceImpl#getUncertaintyLabel <em>Uncertainty Label</em>}</li>
 *   <li>{@link analysiscouplinggraph.impl.RequiredInterfaceImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link analysiscouplinggraph.impl.RequiredInterfaceImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link analysiscouplinggraph.impl.RequiredInterfaceImpl#getMappingModel <em>Mapping Model</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequiredInterfaceImpl extends MinimalEObjectImpl.Container implements RequiredInterface {
	...
	protected EClass eStaticClass() {
		return AnalysiscouplinggraphPackage.Literals.REQUIRED_INTERFACE;
	}
	...
	public EList<UncertaintyLabel> getUncertaintyLabel() {
		if (uncertaintyLabel == null) {
			uncertaintyLabel = new EObjectContainmentEList<UncertaintyLabel>(UncertaintyLabel.class, this, AnalysiscouplinggraphPackage.REQUIRED_INTERFACE__UNCERTAINTY_LABEL);
		}
		...
		if (owner != null && owner.eIsProxy()) {
			...
			if (owner != oldOwner) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AnalysiscouplinggraphPackage.REQUIRED_INTERFACE__OWNER, oldOwner, owner));
			}
		}
		return owner;
	}
	...
	public void setOwner(AnalysisComponent newOwner) {
		...
		owner = newOwner;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnalysiscouplinggraphPackage.REQUIRED_INTERFACE__OWNER, oldOwner, owner));
	}
	...
	public EList<Annotation> getAnnotations() {
		if (annotations == null) {
			annotations = new EObjectResolvingEList<Annotation>(Annotation.class, this, AnalysiscouplinggraphPackage.REQUIRED_INTERFACE__ANNOTATIONS);
		}
		return annotations;
	}
	...
	public MappingDefinition getMappingModel() {
		if (mappingModel != null && mappingModel.eIsProxy()) {
			...
			if (mappingModel != oldMappingModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AnalysiscouplinggraphPackage.REQUIRED_INTERFACE__MAPPING_MODEL, oldMappingModel, mappingModel));
			}
		}
		return mappingModel;
	}
	...
	public void setMappingModel(MappingDefinition newMappingModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnalysiscouplinggraphPackage.REQUIRED_INTERFACE__MAPPING_MODEL, oldMappingModel, mappingModel));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AnalysiscouplinggraphPackage.REQUIRED_INTERFACE__UNCERTAINTY_LABEL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AnalysiscouplinggraphPackage.REQUIRED_INTERFACE__OWNER:
				if (resolve) return getOwner();
				return basicGetOwner();
			case AnalysiscouplinggraphPackage.REQUIRED_INTERFACE__ANNOTATIONS:
				return getAnnotations();
			case AnalysiscouplinggraphPackage.REQUIRED_INTERFACE__MAPPING_MODEL:
